...
sudo iptables -t nat -D PREROUTING -i tun0 -s $SIP -p tcp --dport 80 -j DNAT --to-destination $HTTP_IP
...
# sudo iptables -t nat -A PREROUTING -d 10.13.0.5 -p tcp --dport 80 -j DNAT --to-destination 149.28.240.117
# sudo iptables -t nat -A POSTROUTING -s 149.28.240.117 -p tcp -j SNAT --to 192.168.0.5
